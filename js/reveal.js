...
(function(root, factory) {
    ...
    function initialize(options) {
        ...
        if (options.target) {
            dom.wrapper = typeof options.target === "string" ? document.querySelector(options.target) : options.target;
			
			var eleQueue = [dom.wrapper];
			...
			console.log('target:',dom.wrapper,dom.slides);
        } else {
    ...
    function checkCapabilities() {
        ...
        features.zoom =
            "zoom" in testElement.style && !isMobileDevice && (isChrome || /Version\/[\d\.]+.*Safari/.test(UA));
    }
    ...
    function updateNotes() {
        if (config.showNotes && dom.speakerNotes && currentSlide && !isPrintingPDF()) {
            dom.speakerNotes.innerHTML =
                getSlideNotes() || '<span class="notes-placeholder">No notes on this slide.</span>';
        }
    }
    ...
    function unloadSlide(slide) {
        ...
        toArray(slide.querySelectorAll("video[data-lazy-loaded] source[src], audio source[src]")).forEach(function(
            source
        ) {
